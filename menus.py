...
class Menus:
    ...
    def __init__(self, WIN, menu_name, advanced_menu_set = []):
        self.WIN = WIN
        ...
        elif menu_name == 'resolution':
            self.menu_text = interface.resolutions_menu_text
    ...
    def rectangles_for_menu(self):
        ...
        unused_height = constants.HEIGHT - total_buttons_height - self.logo_height
        ...
        button_width = constants.WIDTH * self.fract_WIDTH
        header_width = 0.9 * constants.WIDTH
        header_height = self.rect_height + 20
        y = constants.HEIGHT / 2 - rectangles_height / 2
